classdef TS_RRCForest
    %Static utility class for Robust Random Cut (RRC) Forest model related
    ...
    properties (Constant)
        Name (1,1) string = m('predmaint_anomaly:anomaly_app:strRRCForest')
        Description (1,1) string = m('predmaint_anomaly:anomaly_app:tipRRCForest')
        Type (1,1) string = "rrcforest"
        IconName (1,1) string = "decisionTreeSimple"

        % Overview Panel
        ScoringDescription (1,1) string = m('predmaint_anomaly:anomaly_app:descRrcforest');
        BestSuitedDescription (1,1) string = m('predmaint_anomaly:anomaly_app:bestSuitedRrcforest');
        TuningRecommendationDescription (1,1) string = m('predmaint_anomaly:anomaly_app:tuningRecommendationRrcforest');
    ...
    methods (Static)
        function createTrainOptionsPanel(PanelOptionsObj, ModelStore, modelName)
            ...
            import anomalyAPP.internal.app.modelmanager.TS_RRCForest
            ...
            numLearnersSpinner = UiWidgetFactory.createSpinner(trainingGrid, limits, ...
                TS_RRCForest.defaultModelConfig.NumLearnersSpinner, step, row, roundFractional);
            numLearnersSpinner.ValueChangedFcn  = @(es,ed)...
            ...
            numObservationPerLearnerSpinner = UiWidgetFactory.createSpinner(trainingGrid, limits, ...
                TS_RRCForest.defaultModelConfig.NumObservationPerLearnerSpinner, step, row, ...
                roundFractional, upperLimitInclusive, lowerLimitInclusive);
            numObservationPerLearnerSpinner.ValueChangedFcn  = @(es,ed)...
                GenericCallbacks.updateField(ed, ModelStore, modelName, 'TipConfig', 'NumObservationPerLearnerSpinner');

            % UseParallel Dropdown
            UiWidgetFactory.createLabel(trainingGrid, ...
                m('predmaint_anomaly:anomaly_app:strUseParallel'), 3,...
            ...
            useParallelDropdown = UiWidgetFactory.createDropdown(trainingGrid, ...
                ...
                {'yes', 'no'}, ...
                TS_RRCForest.defaultModelConfig.UseParallelDropdown, 3, false);
            useParallelDropdown.ValueChangedFcn  = @(es,ed)...
            ...
            trainingStrideSpinner = UiWidgetFactory.createSpinner(trainingGrid, limits, ...
                TS_RRCForest.defaultModelConfig.TrainingStrideSpinner, step, row, roundFractional);
            trainingStrideSpinner.ValueChangedFcn  = @(es,ed)...
            ...
            featureExtractDropdown = UiWidgetFactory.createDropdown(modelGrid, ...
                ...
                TS_RRCForest.defaultModelConfig.FeatureExtractDropdown, 1, false);
            featureExtractDropdown.ValueChangedFcn  = @(es,ed)...
            ...
            normalizeDropdown = UiWidgetFactory.createDropdown(modelGrid, [m('predmaint_anomaly:anomaly_app:strZscore'), ...
                m('predmaint_anomaly:anomaly_app:strRange'), m('predmaint_anomaly:anomaly_app:strOff')], ...
                {'zscore', 'range', 'off'}, ...
                TS_RRCForest.defaultModelConfig.NormalizeDropdown, 2, false);
            normalizeDropdown.ValueChangedFcn  = @(es,ed)...
            ...
            windowLengthSpinner = UiWidgetFactory.createSpinner(modelGrid, limits, ...
                TS_RRCForest.defaultModelConfig.WindowLengthSpinner, step, row, roundFractional); %Range right limit needs to be dynamic
            windowLengthSpinner.ValueChangedFcn  = @(es,ed)...
        ...
        function createDetectOptionsPanel(PanelOptionsObj, ModelStore, modelName)
            ...
            detectionStrideSpinner = UiWidgetFactory.createSpinner(detectionGrid, limits, ...
                TS_RRCForest.defaultDetectConfig.DetectionStrideSpinner, step, row, roundFractional);
            detectionStrideSpinner.ValueChangedFcn  = @(es,ed)...
            ...
            thresholdMethodDropdown = UiWidgetFactory.createDropdown(detectionGrid,...
                ...
                TS_RRCForest.defaultDetectConfig.ThresholdMethodDropdown, 2, false);
            thresholdMethodDropdown.ValueChangedFcn  = @(es,ed)...
            ...
            thresholdParamSpinner = UiWidgetFactory.createSpinner(detectionGrid, limits, ...
                TS_RRCForest.defaultDetectConfig.ThresholdParamSpinner, step, row, roundFractional);
            thresholdParamSpinner.ValueChangedFcn  = @(es,ed)...
            ...
            thresholdSpinner = UiWidgetFactory.createSpinner(detectionGrid, limits, ...
                TS_RRCForest.defaultDetectConfig.ThresholdSpinner, step, row, roundFractional);
            thresholdSpinner.ValueChangedFcn  = @(es,ed)...
        ...
        function [mdl, monitor] = trainModel(data, cc)
            ...
            mdl = timeSeriesRrcforestAD(size(data{1},2), ...
        ...
        function fillOverviewDiagram(OverviewPanel, modelOverview)
            ...
            % modelOverview {{anomalyLeafId, G, nodeLabels}}
            anomalyLeafId = modelOverview{1}{1};
            G = modelOverview{1}{2};
            nodeLabels = modelOverview{1}{3};
